                            ...
                            (t.controllers.line = t.DatasetController.extend({
                                ...
                                updateElement: function (t, e, i) {
                                    ...
                                    void 0 !== d.radius && void 0 === d.pointRadius && (d.pointRadius = d.radius),
                                        ...
                                        (n = f.getPixelForValue("object" == typeof c ? c : NaN, e, u, r.chart.isCombo)),
                                ...
                                updateBezierControlPoints: function () {
                                    ...
                                    for (e = 0, i = u.length; i > e; ++e)
                                        (n = u[e]),
                                            ...
                                            (o.controlPointPreviousX = t(r.previous.x, d.left, d.right)),
                                            (o.controlPointPreviousY = t(r.previous.y, d.top, d.bottom)),
                    ...
                    e.exports = function (t) {
                        ...
                        t.layoutService = {
                            ...
                            update: function (t, a, i) {
                                ...
                                function l(t) {
                                    t.isHorizontal()
                                        ? ((t.left = t.options.fullWidth ? s : C), (t.right = t.options.fullWidth ? a - s : C + k), (t.top = P), (t.bottom = P + t.height), (P = t.bottom))
                                        : ((t.left = F), (t.right = F + t.width), (t.top = D), (t.bottom = D + S), (F = t.right));
                                }
                                if (t) {
                                    var s = 0,
                                        d = 0,
                        ...
                        (t.defaults.scale = {
                            ...
                            (t.Scale = t.Element.extend({
                                ...
                                fit: function () {
                                    ...
                                    if (
                                        (d ? (i.width = a.isFullWidth() ? a.maxWidth - a.margins.left - a.margins.right : a.maxWidth) : (i.width = s ? p : 0),
                                    ...
                                    if (n.display) {
                                        ...
                                        if (
                                            (e.each(i.ticks, function (t, r) {
                                                if (void 0 !== t && null !== t) {
                                                    ...
                                                    if ((!s || l) && void 0 !== t && null !== t) {
                                                        ...
                                                        T.push({ tx1: p, ty1: m, tx2: b, ty2: v, x1: x, y1: k, x2: S, y2: w, labelX: C, labelY: M, glWidth: c, glColor: f, rotation: -1 * D, label: t, textBaseline: I, textAlign: A });
                                                    }
                                                }
                                            }),
                                                e.each(T, function (t) {
                                            ...
                                            if (g) (V = i.left + (i.right - i.left) / 2), (L = "bottom" === n.position ? i.bottom - S / 2 : i.top + S / 2);
                                                ...
                                                (V = B ? i.left + S / 2 : i.right - S / 2), (L = i.top + (i.bottom - i.top) / 2), (O = B ? -0.5 * Math.PI : 0.5 * Math.PI);
                                            }
                                        ...
                                        if (u.drawBorder) {
                                            ...
                                            g ? ((N = H = "top" === n.position ? i.bottom : i.top), (N += E), (H += E)) : ((W = z = "left" === n.position ? i.right : i.left), (W += E), (z += E)),
                                                l.beginPath(),
                                                l.moveTo(W, N),
                                                l.lineTo(z, H),
                                                l.stroke();
                                ...
                                getPixelForValue: function (t) {
                                    ...
                                    return (
                                        n.isHorizontal()
                                            ? 0 === r
                                                ? (i = n.left + u)
                                                : ((a = n.width - (u + n.paddingRight)), (i = n.left + (a / l) * (e.log10(r) - e.log10(o))), (i += u))
                                            : 0 === r
                                                ? (i = n.top + s)
                                                : ((a = n.height - (s + d)), (i = n.bottom - d - (a / l) * (e.log10(r) - e.log10(o)))),
                                        i
                                    );
                                },
                                getValueForPixel: function (t) {
